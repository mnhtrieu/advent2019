...
You can use an [Intcode](https://github.com/mnhtrieu/advent2019/tree/master/9_day) program (your puzzle input) running on an [ASCII-capable](https://github.com/mnhtrieu/advent2019/tree/master/17_day) computer to [program](https://en.wikipedia.org/wiki/Programmable_read-only_memory) the springdroid. However, springdroids don't run Intcode; instead, they run a simplified assembly language called **springscript**.
